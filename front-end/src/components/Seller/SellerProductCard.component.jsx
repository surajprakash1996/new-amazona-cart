...
const ProductCardComponent = (props) => {
  ...
  const { _id, name, brand, image, price, reviews, rating, seller, countInStock } =
    productInfo;
    ...
    <Card className={classes.root}>
      <CardActionArea>
        ...
        <CardContent>
          ...
          <Box my={1}>
             <Button color="primary" style={{textDecoration: 'captalize', fontWeight:'bold'}}>{seller.seller.sellerName}</Button>
          </Box>
